...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<span><span class=\"pageinfo\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</span></span>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<span><span class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</span></span>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<span><span class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span></span>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<span><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></span>\r\n";
            $indexpage="<span><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></span>\r\n";
        }
        else
        {
        ...
        {
            $nextpage.="<span><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a></span>\r\n";
            $endpage="<span><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></span>\r\n";
        }
        else
        {
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<span><a href='".str_replace("{page}",$j,$tnamerule)."'>".$j."</a></span>\r\n";
            }
        }
        $plist = '';
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<span><span class=\"pageinfo\">共 1 页/".$this->TotalResult." 条记录</span></span>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<span><span class=\"pageinfo\">共 0 页/".$this->TotalResult." 条记录</span></span>\r\n";
        }
        $maininfo = "<span><span class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span></span>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<span><a href='".$purl."PageNo=$prepagenum'>上一页</a></span>\r\n";
            $indexpage="<span><a href='".$purl."PageNo=1'>首页</a></span>\r\n";
        }
        else
        {
            $indexpage="<span><a>首页</a></span>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<span><a href='".$purl."PageNo=$nextpagenum'>下一页</a></span>\r\n";
            $endpage="<span><a href='".$purl."PageNo=$totalpage'>末页</a></span>\r\n";
        }
        else
        {
            $endpage="<span><a>末页</a></span>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span class=\"thisclass\"><a>$j</a></span>\r\n";
            }
            else
            {
                $listdd.="<span><a href='".$purl."PageNo=$j'>".$j."</a></span>\r\n";
            }
        }
